...
export const strategy = {
  strategyId: "create-product.not-implemented.v1",
  strategyPath: "src/tasks/task-create-product/strategies/not-implemented.ts",
  taskId: CREATE_PRODUCT_TASK_ID,
  name: "Not implemented",
  summary:
    "Draft stub strategy for task create-product.",
  hypothesis:
  ...
  stepOutline: [
    "Throw an explicit not-yet-implemented error for task create-product.",
  ],
  status: "draft",
  async run(
