...
export const REGISTER_CUSTOMER_INVOICE_PAYMENT_TASK_ID = "register-customer-invoice-payment";
export const REGISTER_CUSTOMER_INVOICE_PAYMENT_TX_TASK_ID = "17";
export const REGISTER_CUSTOMER_INVOICE_PAYMENT_INPUT_SCHEMA_ID = "register-customer-invoice-payment.v1";
