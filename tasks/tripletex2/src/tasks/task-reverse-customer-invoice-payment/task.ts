...
export const REVERSE_CUSTOMER_INVOICE_PAYMENT_TASK_ID = "reverse-customer-invoice-payment";
export const REVERSE_CUSTOMER_INVOICE_PAYMENT_TX_TASK_ID = "18";
export const REVERSE_CUSTOMER_INVOICE_PAYMENT_INPUT_SCHEMA_ID = "reverse-customer-invoice-payment.v1";
