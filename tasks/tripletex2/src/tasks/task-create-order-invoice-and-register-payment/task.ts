...
export const CREATE_ORDER_INVOICE_AND_REGISTER_PAYMENT_TASK_ID = "create-order-invoice-and-register-payment";
export const CREATE_ORDER_INVOICE_AND_REGISTER_PAYMENT_TX_TASK_ID = "11";
export const CREATE_ORDER_INVOICE_AND_REGISTER_PAYMENT_INPUT_SCHEMA_ID = "create-order-invoice-and-register-payment.v1";
