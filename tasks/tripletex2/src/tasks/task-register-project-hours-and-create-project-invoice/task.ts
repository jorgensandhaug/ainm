...
export const REGISTER_PROJECT_HOURS_AND_CREATE_PROJECT_INVOICE_TASK_ID = "register-project-hours-and-create-project-invoice";
export const REGISTER_PROJECT_HOURS_AND_CREATE_PROJECT_INVOICE_TX_TASK_ID = "15";
export const REGISTER_PROJECT_HOURS_AND_CREATE_PROJECT_INVOICE_INPUT_SCHEMA_ID = "register-project-hours-and-create-project-invoice.v1";
