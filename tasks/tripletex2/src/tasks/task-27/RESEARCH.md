# Task 27 — Register foreign-currency payment with exchange gain Research Memory
...
- Canonical task id: `27`
- Active strategy pin: `27.not-implemented.v1`
...
- Priority: `32`
- Band: `kill`
- Queue eligibility: `do-not-work`
- Best known score: `6` / `6`

## Current State

### Queue Notes

- Reached tier max score (6/6). Endpoint-killed for score chasing.
