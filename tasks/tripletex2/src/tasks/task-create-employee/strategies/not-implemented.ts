...
export const strategy = {
  strategyId: "create-employee.not-implemented.v1",
  strategyPath: "src/tasks/task-create-employee/strategies/not-implemented.ts",
  taskId: CREATE_EMPLOYEE_TASK_ID,
  name: "Not implemented",
  summary:
    "Draft stub strategy for task create-employee.",
  hypothesis:
  ...
  stepOutline: [
    "Throw an explicit not-yet-implemented error for task create-employee.",
  ],
  status: "draft",
  async run(
