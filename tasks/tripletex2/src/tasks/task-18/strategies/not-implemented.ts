...
export const strategy = {
  strategyId: "18.not-implemented.v1",
  strategyPath: "src/tasks/task-18/strategies/not-implemented.ts",
  taskId: REVERSE_CUSTOMER_INVOICE_PAYMENT_TASK_ID,
  name: "Not implemented",
  summary:
    "Draft stub strategy for task 18.",
  hypothesis:
  ...
  stepOutline: [
    "Throw an explicit not-yet-implemented error for task 18.",
  ],
  status: "draft",
  async run(
