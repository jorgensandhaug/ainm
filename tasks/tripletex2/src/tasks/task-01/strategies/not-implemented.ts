...
export const strategy = {
  strategyId: "01.not-implemented.v1",
  strategyPath: "src/tasks/task-01/strategies/not-implemented.ts",
  taskId: CREATE_CUSTOMER_TASK_ID,
  name: "Not implemented",
  summary:
    "Draft stub strategy for task 01.",
  hypothesis:
  ...
  stepOutline: [
    "Throw an explicit not-yet-implemented error for task 01.",
  ],
  status: "draft",
  async run(
