...
export const REGISTER_SUPPLIER_INVOICE_TASK_ID = "register-supplier-invoice";
export const REGISTER_SUPPLIER_INVOICE_TX_TASK_ID = "16";
export const REGISTER_SUPPLIER_INVOICE_INPUT_SCHEMA_ID = "register-supplier-invoice.v1";
