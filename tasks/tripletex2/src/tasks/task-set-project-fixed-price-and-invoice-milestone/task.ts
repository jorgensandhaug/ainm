...
export const SET_PROJECT_FIXED_PRICE_AND_INVOICE_MILESTONE_TASK_ID = "set-project-fixed-price-and-invoice-milestone";
export const SET_PROJECT_FIXED_PRICE_AND_INVOICE_MILESTONE_TX_TASK_ID = "14";
export const SET_PROJECT_FIXED_PRICE_AND_INVOICE_MILESTONE_INPUT_SCHEMA_ID = "set-project-fixed-price-and-invoice-milestone.v1";
