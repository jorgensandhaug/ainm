...
export const CREATE_ACCOUNTING_DIMENSION_AND_POST_VOUCHER_TASK_ID = "create-accounting-dimension-and-post-voucher";
export const CREATE_ACCOUNTING_DIMENSION_AND_POST_VOUCHER_TX_TASK_ID = "07";
export const CREATE_ACCOUNTING_DIMENSION_AND_POST_VOUCHER_INPUT_SCHEMA_ID = "create-accounting-dimension-and-post-voucher.v1";
