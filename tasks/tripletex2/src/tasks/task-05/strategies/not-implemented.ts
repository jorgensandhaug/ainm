...
export const strategy = {
  strategyId: "05.not-implemented.v1",
  strategyPath: "src/tasks/task-05/strategies/not-implemented.ts",
  taskId: CREATE_PROJECT_TASK_ID,
  name: "Not implemented",
  summary:
    "Draft stub strategy for task 05.",
  hypothesis:
  ...
  stepOutline: [
    "Throw an explicit not-yet-implemented error for task 05.",
  ],
  status: "draft",
  async run(
