...
export const strategy = {
  strategyId: "register-travel-expense.not-implemented.v1",
  strategyPath: "src/tasks/task-register-travel-expense/strategies/not-implemented.ts",
  taskId: REGISTER_TRAVEL_EXPENSE_TASK_ID,
  name: "Not implemented",
  summary:
    "Draft stub strategy for task register-travel-expense.",
  hypothesis:
  ...
  stepOutline: [
    "Throw an explicit not-yet-implemented error for task register-travel-expense.",
  ],
  status: "draft",
  async run(
