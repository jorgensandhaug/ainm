...
- re-verified again on 2026-03-20 in persistent sandbox with production-like payload `Northwave Reflection Supplier 321000011`, `321000011`, and `faktura-321000011@northwaveltd.no`; one `POST /supplier` with both `email` and `invoiceEmail` returned supplier `id=108286080`, preserved both fields, and returned `ledgerAccount.id=424190921`
