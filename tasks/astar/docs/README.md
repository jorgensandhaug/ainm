...
The canonical doc for this repo now lives in [README.md](/home/jorge/repos/ainm/tasks/astar/README.md).

Exception: [game_facts.md](/home/jorge/repos/ainm/tasks/astar/docs/game_facts.md) is the canonical factual reference for the competition itself.

Use the root README for:

- competition/task summary
- architecture and mental model
- current live and offline pipelines
- model stack
- data layout
- common commands
- human and agent notes

This `docs/` directory is now supplementary only. Current contents:
