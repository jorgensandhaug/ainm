...
from astar.workflows.query_residual_online_audit import QueryResidualOnlineAuditResult
...
def render_query_residual_online_audit(result: QueryResidualOnlineAuditResult) -> str:
    lines = [
