    ...
    def fit_from_dataset(
        ...
        *,
        ...
        for path_value in index_table["episode_path"].to_list():
            resolved_path = resolve_synthetic_episode_path(dataset.index_path, str(path_value))
            summary_vector, regime_vector = _summary_vector_from_artifact(resolved_path)
