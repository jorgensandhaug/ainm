...
_ENSEMBLE_SPECS: dict[str, EnsembleModelSpec] = {
    ...
    # 3-MODEL: hazard + supportx + plain_qr (all low floor)
    "f1_ensemble_hv2f0001_sxf0001_qrf0001_obs20_v01": EnsembleModelSpec(
        model_name="f1_ensemble_hv2f0001_sxf0001_qrf0001_obs20_v01",
        component_model_names=(
            "f1_hazard_posterior_v2_k5_r3_f0001_v01",
            "f1_student_query_residual_supportx_f0001_v01",
            "f1_query_residual_f0001_v01",
        ),
        component_weights=(0.50, 0.25, 0.25),
