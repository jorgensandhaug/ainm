...
FFAM_OPERATOR_CONFIGS: dict[str, FFAMOperatorConfig] = {
    ...
    "ffam_operator_v8": FFAMOperatorConfig(
        model_name="ffam_operator_v8",
        projected_operator_dim=3,
        regime_input_variant="motif_v1",
        posterior_method="local_linear",
        posterior_metric_dim=8,
        ...
        posterior_bandwidth=0.95,
        posterior_retrieval_blend=1.0,
        posterior_ood_prior_blend=0.80,
        prior_blend=0.28,
        residual_class_scale=(0.65, 0.5, 0.45, 0.45, 0.65, 0.75),
        manifold_neighbor_count=0,
        manifold_blend=0.0,
        temperature=1.08,
    ),
    "ffam_operator_v9": FFAMOperatorConfig(
        model_name="ffam_operator_v9",
        projected_operator_dim=3,
        regime_input_variant="motif_v1",
        posterior_method="local_linear",
        posterior_metric_dim=10,
        ...
        posterior_bandwidth=1.20,
        posterior_retrieval_blend=1.0,
        posterior_ood_prior_blend=0.90,
        prior_blend=0.40,
        residual_class_scale=(0.5, 0.35, 0.3, 0.3, 0.5, 0.6),
        manifold_neighbor_count=0,
        manifold_blend=0.0,
        temperature=1.12,
    ),
    "ffam_operator_v10": FFAMOperatorConfig(
        model_name="ffam_operator_v10",
        projected_operator_dim=3,
        regime_input_variant="motif_v1",
        posterior_method="local_linear",
        posterior_metric_dim=10,
        ...
        posterior_bandwidth=1.20,
        posterior_retrieval_blend=1.0,
        posterior_ood_prior_blend=1.0,
        prior_blend=0.60,
        residual_class_scale=(0.35, 0.25, 0.2, 0.2, 0.35, 0.45),
        manifold_neighbor_count=0,
        manifold_blend=0.0,
        temperature=1.15,
    ),
    "ffam_operator_v11": FFAMOperatorConfig(
        model_name="ffam_operator_v11",
        projected_operator_dim=3,
        regime_input_variant="motif_v1",
        posterior_method="local_linear",
        posterior_metric_dim=10,
        ...
        posterior_ood_prior_blend=1.0,
        prior_blend=0.75,
        residual_class_scale=(0.25, 0.18, 0.15, 0.15, 0.25, 0.35),
        manifold_neighbor_count=0,
        manifold_blend=0.0,
        temperature=1.20,
    ),
