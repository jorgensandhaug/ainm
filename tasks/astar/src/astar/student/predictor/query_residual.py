...
QUERY_RESIDUAL_V20 = "query_residual_v20"
QUERY_RESIDUAL_V21 = "query_residual_v21"
QUERY_RESIDUAL_V22 = "query_residual_v22"
...
def resolve_query_residual_variant_spec(
    ...
    *,
    ...
    default_samples_per_round = {
        ...
        QUERY_RESIDUAL_V20: 2,
        QUERY_RESIDUAL_V21: 2,
        QUERY_RESIDUAL_V22: 2,
    ...
    if resolved_model_name == QUERY_RESIDUAL_V16 and effective_samples_per_round != 2:
        raise ValueError("query_residual_v16 fixes samples_per_round=2")
    if resolved_model_name == QUERY_RESIDUAL_V17 and effective_samples_per_round != 2:
    ...
    if resolved_model_name == QUERY_RESIDUAL_V20 and effective_samples_per_round != 2:
        raise ValueError("query_residual_v20 fixes samples_per_round=2")
    if resolved_model_name == QUERY_RESIDUAL_V21 and effective_samples_per_round != 2:
        raise ValueError("query_residual_v21 fixes samples_per_round=2")
    if resolved_model_name == QUERY_RESIDUAL_V22 and effective_samples_per_round != 2:
        raise ValueError("query_residual_v22 fixes samples_per_round=2")
    ...
    if resolved_model_name == QUERY_RESIDUAL_V13:
        return QueryResidualNamedVariantSpec(
            model_name=resolved_model_name,
            samples_per_round=2,
    ...
    if resolved_model_name == QUERY_RESIDUAL_V16:
        return QueryResidualNamedVariantSpec(
            model_name=resolved_model_name,
            samples_per_round=2,
            prior_blend=0.25,
    ...
    if resolved_model_name == QUERY_RESIDUAL_V17:
        return QueryResidualNamedVariantSpec(
            model_name=resolved_model_name,
            samples_per_round=2,
            prior_blend=0.15,
    ...
    if resolved_model_name == QUERY_RESIDUAL_V18:
        return QueryResidualNamedVariantSpec(
            model_name=resolved_model_name,
            samples_per_round=2,
            prior_blend=0.05,
    ...
    if resolved_model_name == QUERY_RESIDUAL_V20:
        return QueryResidualNamedVariantSpec(
            model_name=resolved_model_name,
            samples_per_round=2,
            prior_blend=0.0,
    ...
    if resolved_model_name == QUERY_RESIDUAL_V21:
        return QueryResidualNamedVariantSpec(
            model_name=resolved_model_name,
            samples_per_round=2,
            prior_blend=0.0,
    ...
    if resolved_model_name == QUERY_RESIDUAL_V22:
        return QueryResidualNamedVariantSpec(
            model_name=resolved_model_name,
            samples_per_round=2,
            prior_blend=0.0,
