...
TRIPLE_BLEND_V001 = "triple_blend_v001"  # GLMM 40% + DT 30% + PriorOp 30% + obs
TRIPLE_BLEND_V002 = "triple_blend_v002"  # GLMM 50% + DT 25% + PriorOp 25% + obs
TRIPLE_BLEND_V003 = "triple_blend_v003"  # GLMM 35% + DT 35% + PriorOp 30% + obs
TRIPLE_BLEND_V004 = "triple_blend_v004"  # GLMM 45% + DT 30% + PriorOp 25% + obs
TRIPLE_BLEND_V005 = "triple_blend_v005"  # GLMM 40% + DT 40% + PriorOp 20% + obs
TRIPLE_BLEND_V006 = "triple_blend_v006"  # best_ensemble + 20% PriorOp + obs
TRIPLE_BLEND_V007 = "triple_blend_v007"  # fine-tune: 33/33/34
TRIPLE_BLEND_V008 = "triple_blend_v008"  # fine-tune: 30/35/35
TRIPLE_BLEND_V009 = "triple_blend_v009"  # fine-tune: 35/30/35
TRIPLE_BLEND_V010 = "triple_blend_v010"  # fine-tune: 30/40/30
TRIPLE_BLEND_V011 = "triple_blend_v011"  # v003 but obs t=15
TRIPLE_BLEND_V012 = "triple_blend_v012"  # v003 but obs t=25
TRIPLE_BLEND_V013 = "triple_blend_v013"  # 25/35/40 (most PO)
TRIPLE_BLEND_V014 = "triple_blend_v014"  # 25/40/35 (most DT)
TRIPLE_BLEND_V015 = "triple_blend_v015"  # 20/40/40 (minimal GLMM)
...
DIRECT_TERMINAL_Z2_EW_V001 = "direct_terminal_z2_ew_v001"  # entropy-weighted
...
class TripleBlendPredictor(BaseRoundPredictor):
    """Blend three models with fixed weights."""
    ...
    def build_prediction_bundle_from_context(
        ...
        predictions_by_seed: dict[int, np.ndarray] = {}
        for seed_index in bundle_a.predictions_by_seed:
            pred_a = np.asarray(bundle_a.predictions_by_seed[seed_index], dtype=np.float64)
            pred_b = np.asarray(bundle_b.predictions_by_seed[seed_index], dtype=np.float64)
            pred_c = np.asarray(bundle_c.predictions_by_seed[seed_index], dtype=np.float64)
            blended = self.weight_a * pred_a + self.weight_b * pred_b + self.weight_c * pred_c
...
def build_online_predictor(
    ...
    *,
    ...
    if normalized in (TRIPLE_EW_R005_V001, TRIPLE_EW_R0005_V001, TRIPLE_EW_R0002_V001, TRIPLE_EW_R0001_V001):
        ...
        ridge_map = {
            TRIPLE_EW_R005_V001: (0.005, DIRECT_TERMINAL_Z2_EW_V002),
    ...
    if normalized == DIRECT_TERMINAL_Z2_EW_V001:
        ...
        return _build_direct_terminal_adapter(
            workspace_paths,
            historical_round_ids=historical_round_ids,
            checkpoint_stem=DIRECT_TERMINAL_Z2_EW_V001,
    ...
    if normalized in (TRIPLE_EW_V001, TRIPLE_EW_V002, TRIPLE_EW_V003, TRIPLE_EW_V004, TRIPLE_EW_V005, TRIPLE_EW_V006, TRIPLE_EW_V007, TRIPLE_EW_V008):
        ...
        dt_ew_adapter = _build_direct_terminal_adapter(
            workspace_paths,
            historical_round_ids=historical_round_ids,
            checkpoint_stem=DIRECT_TERMINAL_Z2_EW_V001,
            model_name=DIRECT_TERMINAL_Z2_EW_V001,
        ...
        base_predictor = TripleBlendPredictor(
            predictor_a=glmm_adapter.predictor,
            predictor_b=dt_ew_adapter.predictor,
            predictor_c=prior_op,
            weight_a=wa,
            weight_b=wb,
            weight_c=wc,
    ...
    if normalized in (TRIPLE_BLEND_V001, TRIPLE_BLEND_V002, TRIPLE_BLEND_V003, TRIPLE_BLEND_V004, TRIPLE_BLEND_V005, TRIPLE_BLEND_V006, TRIPLE_BLEND_V007, TRIPLE_BLEND_V008, TRIPLE_BLEND_V009, TRIPLE_BLEND_V010, TRIPLE_BLEND_V011, TRIPLE_BLEND_V012, TRIPLE_BLEND_V013, TRIPLE_BLEND_V014, TRIPLE_BLEND_V015, TRIPLE_BLEND_V016, TRIPLE_BLEND_V017, TRIPLE_BLEND_V018, TRIPLE_BLEND_V019, TRIPLE_BLEND_V020, TRIPLE_BLEND_V021, TRIPLE_BLEND_V022, TRIPLE_BLEND_V023, TRIPLE_BLEND_V024):
        ...
        weight_configs = {
            TRIPLE_BLEND_V001: (0.40, 0.30, 0.30),  # balanced
            TRIPLE_BLEND_V002: (0.50, 0.25, 0.25),  # GLMM-heavy
            TRIPLE_BLEND_V003: (0.35, 0.35, 0.30),  # DT-heavy
            TRIPLE_BLEND_V004: (0.45, 0.30, 0.25),  # GLMM+DT
            TRIPLE_BLEND_V005: (0.40, 0.40, 0.20),  # GLMM+DT, less PO
            TRIPLE_BLEND_V006: (0.40, 0.25, 0.35),  # more PO
            TRIPLE_BLEND_V007: (0.33, 0.33, 0.34),
            TRIPLE_BLEND_V008: (0.30, 0.35, 0.35),
            TRIPLE_BLEND_V009: (0.35, 0.30, 0.35),
            TRIPLE_BLEND_V010: (0.30, 0.40, 0.30),
            TRIPLE_BLEND_V011: (0.35, 0.35, 0.30),  # same as v003
            TRIPLE_BLEND_V012: (0.35, 0.35, 0.30),  # same as v003
            TRIPLE_BLEND_V013: (0.25, 0.35, 0.40),
            TRIPLE_BLEND_V014: (0.25, 0.40, 0.35),
            TRIPLE_BLEND_V015: (0.20, 0.40, 0.40),
        ...
        # Add observation blending on top
        obs_temp = {
            TRIPLE_BLEND_V011: 15.0,
            TRIPLE_BLEND_V012: 25.0,
            TRIPLE_BLEND_V018: 15.0,
        }.get(normalized, 20.0)
        obs_predictor = ExactObservationBlendPredictor(
            base_predictor=base_predictor,
            beta_min=obs_temp,
