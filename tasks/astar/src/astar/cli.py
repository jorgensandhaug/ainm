...
def build_parser() -> argparse.ArgumentParser:
    ...
    model_prediction_parser.add_argument(
        ...
        choices=[
            ...
            "hazard_posterior_v2",
            "hazard_posterior_v2_k3_r2",
            "hazard_posterior_v2_k5_r3",
            "hazard_posterior_v2_k9_r4",
            "hazard_posterior_v2_blend_a20_k5_r3",
            "hazard_posterior_v2_blend_a35_k5_r3",
            "hazard_posterior_v3",
            "hazard_posterior_v3_k5_r3_l8_m35",
            "hazard_posterior_v3_k9_r4_l8_m35",
            "hazard_posterior_v4",
            "hazard_posterior_v4_k5_r3_l16_m50",
            "hazard_posterior_v4_k9_r4_l16_m50",
            "query_residual",
        ],
        required=True,
    )
