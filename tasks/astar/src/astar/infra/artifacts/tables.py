...
from astar.core.terrain import map_internal_code
from astar.infra.api.dto import StoredRoundRecord
from astar.infra.artifacts.paths import WorkspacePaths
from astar.infra.artifacts.store import QueryFileRecord
...
def write_round_tables(paths: WorkspacePaths, record: StoredRoundRecord) -> None:
...
def write_query_tables(
    ...
    round_id: str,
    query_files: list[QueryFileRecord],
) -> None:
...
__all__ = [
    ...
    "StoredRoundRecord",
    "WorkspacePaths",
    "build_cell_observations_frame",
    "build_query_log_frame",
    "build_round_frame",
    "build_seed_initial_states_frame",
    "build_settlement_observations_frame",
    "write_query_tables",
    "write_round_tables",
]
