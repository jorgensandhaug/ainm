...
def run_historical_benchmark(
    ...
    *,
    ...
    is_transcript_model = normalized_model_name in transcript_models or normalized_model_name.startswith("greybox_stacked") or normalized_model_name.startswith("greybox_tristack") or normalized_model_name.startswith("greybox_multiregime")
