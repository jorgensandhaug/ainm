...
def test_cli_accepts_round_heatmap_factor_residual_historical_benchmark_model() -> None:
    parser = build_parser()
    ...
    assert args.model == "round_heatmap_factor_residual_v2"


def test_cli_accepts_round_heatmap_residual_memory_historical_benchmark_model() -> None:
    parser = build_parser()
...
def test_cli_accepts_round_heatmap_kernel_residual_historical_benchmark_model() -> None:
    parser = build_parser()
...
def test_cli_accepts_round_multiview_factor_residual_historical_benchmark_model() -> None:
    parser = build_parser()
    ...
    assert args.model == "round_multiview_factor_residual_v2"
