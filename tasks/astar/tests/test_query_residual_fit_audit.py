...
def test_query_residual_fit_audit_runs_on_two_round_sample(sample_paths: RepoPaths) -> None:
    ...
    result = run_query_residual_fit_audit(
        ...
        dataset_name="query_residual_fit_audit_test_dataset",
        audit_name="query_residual_fit_audit_test",
        policy_name="coverage",
        samples_per_round=1,
        budget=2,
    )

    assert result.model_name == "query_residual_v7"
