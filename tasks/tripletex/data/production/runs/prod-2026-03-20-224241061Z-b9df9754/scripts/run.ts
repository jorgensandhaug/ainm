...
const SESSION_TOKEN = "sDGVUdDTYYzXiTQgXFQq_TdJR5-beutveIH0khVS2uk";

const RUN_DATE = "2026-03-20";
const EMPLOYEE_EMAIL = "anna.wagner@example.org";
const PROJECT_NAME = "Sicherheitsaudit";
const CUSTOMER_NAME = "Waldstein GmbH";
const CUSTOMER_ORG_NO = "948366207";
    ...
    JSON.stringify(
      {
        ...
        timesheetProjectChargeableHours: timesheetEntry.projectChargeableHours,
