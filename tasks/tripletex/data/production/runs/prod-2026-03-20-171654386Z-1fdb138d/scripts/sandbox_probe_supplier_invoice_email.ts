...
const payload = {
  name: "Codex Reflection Supplier Bergvik InvoiceEmail 321654387",
  organizationNumber: "321654387",
  email: "faktura-321654387@example.no",
  invoiceEmail: "faktura-321654387@example.no",
};
