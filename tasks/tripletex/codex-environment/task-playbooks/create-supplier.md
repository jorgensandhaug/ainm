...
- production 2026-03-22: French prompt `Lumière SARL` / `879852439` — 1 POST with mirrored email, 0 errors; 13th run on this standard path; 3rd French prompt confirmed
