...
- preemptive bank-account resolution tested in persistent sandbox on 2026-03-21:
  ...
  - conclusion: keep the reactive try-first approach; only enter the repair branch when `POST /invoice` actually returns the bank-account 422
