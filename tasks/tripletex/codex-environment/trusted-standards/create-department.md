...
- production re-confirmed on 2026-03-22 with a Norwegian three-department prompt for `Markedsføring`, `Produksjon`, and `Innkjøp` (779e69a3): one `POST /department/list`, 201, 1 call 0 errors; sandbox re-verified same day
