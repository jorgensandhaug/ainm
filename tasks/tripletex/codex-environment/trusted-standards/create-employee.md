...
- out of 15 known production create-employee runs, 4 succeeded without department and 9 needed it (2 used pre-read so requirement is indeterminate); dept-required rate is at least 60%
