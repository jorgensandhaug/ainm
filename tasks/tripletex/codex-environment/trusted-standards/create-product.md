...
- do not add `GET /product` pre-reads for a pure create task; verification `GET /product/{id}?fields=*,vatType(*)` after the write is always recommended (GETs are free)
