...
- persistent-sandbox verification on 2026-03-22 confirmed the sandbox still has only `OUTGOING` VAT row `id=6` / `0%`; sandbox remains blocked for 15% and 25% VAT product verification
