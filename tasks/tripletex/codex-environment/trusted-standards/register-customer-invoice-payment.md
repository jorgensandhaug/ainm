...
- 2026-03-21 production run for `975013723` + `45100` + `Licence logicielle` (French prompt) confirmed the same exact `3`-call path, located invoice `2147575109` with live outstanding `56375`, used payment type `28394732` (`Betalt til bank`, debit `1920`), and reduced remaining outstanding to `0`; this run matched the trusted standard exactly with zero wasted calls or errors; 13th production confirmation of this task shape
- 2026-03-21 production run for `939210970` + `23900` + `Manutenção` (Portuguese prompt) confirmed the same exact `3`-call path, located invoice `2147575326` with live outstanding `29875`, used payment type `28406443` (`Betalt til bank`, debit `1920`), and reduced remaining outstanding to `0`; this run matched the trusted standard exactly with zero wasted calls or errors; 14th production confirmation of this task shape; second Portuguese confirmation
- same-day sandbox re-proof confirmed `fields=*,payments(*)`, `fields=*,payment(*)`, and `fields=*,paymentTypes(*)` all return `400` on `GET /invoice`; `paymentTypeId=0` on `PUT /:payment` returns `500`; `/ledger/paymentType` returns `404`; no 2-call standalone shortcut exists
- 2026-03-21 production run for `866946108` + `43300` + `Sesión de formación` (Spanish prompt) confirmed the same exact `3`-call path, located invoice `2147575475` with live outstanding `54125`, used payment type `28417664` (`Betalt til bank`, debit `1920`), and reduced remaining outstanding to `0`; this run matched the trusted standard exactly with zero wasted calls or errors; 15th production confirmation of this task shape; second Spanish confirmation
